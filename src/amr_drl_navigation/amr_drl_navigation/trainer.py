...
from amr_drl_navigation.utils import save_path, frames_to_gif, save_replay_buffer, load_replay_buffer
from amr_drl_navigation.get_replay_buffer import get_replay_buffer
from amr_drl_navigation.prepare_output_dir import prepare_output_dir
from amr_drl_navigation.initialize_logger import initialize_logger
from amr_drl_navigation.normalizer import EmpiricalNormalizer
...
class Trainer:
    ...
    def _set_check_point(self, model_dir):
        ...
        if not os.path.exists(self._output_dir):
            try:
                ...
                self.logger.info(f"Created output directory: {self._output_dir}")
            except Exception as e:
                self.logger.critical(f"FATAL: Failed to create output directory {self._output_dir}: {e}")
                raise
    ...
    def get_argument(parser=None):
        ...
        parser.add_argument('--save-model-interval', type=int, default=int(10),
