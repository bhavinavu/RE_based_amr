...
from amr_drl_navigation.policy_base import OffPolicyAgent
from amr_drl_navigation.target_update_ops import update_target_variables
from amr_drl_navigation.tfp_gaussian_actor import GaussianActor
from amr_drl_navigation.tfp_convmix_gaussian_actor import ConvGaussianActor
from amr_drl_navigation.actor_critic_networks import CriticQ, ConvCriticQ, ConvMixCriticQ
...
class SAC(OffPolicyAgent):
    ...
    def _get_action_body(self, state, test):
        actions, log_pis = self.actor(state, training= test)
        return actions
